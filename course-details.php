  ...
  <body>
    ...
    <section class="page_title">
      <div class="image_overlay">
        <article class="container course_title">
          <!-- data from course-details.js -->
        </article>
      </div>
    </section>
    ...
    <section class="related_courses">
      <div class="container related_courses_container">
        <div class="heading">
          <div>
            <p class="similar_courses">More Similar Courses</p>
        ...
        <article class="related_courses_content">
          <!-- data from course-details.js -->
        </article>
      </div>
    </section>
