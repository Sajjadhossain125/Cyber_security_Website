  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#">Contact-us</a> <!-- Change this -->
        </li>
        <li class="nav-item">
      ...
      <tbody>
        ...
        while ($row = $result->fetch_assoc()) {
          echo "<tr>
                  ...
                  <td>{$row['message']}</td>
                  <td>
                   <span class='edit'> <a  href='#?id={$row['name']}'>Update</a></span>
                    <a class='delete' href='delete_contact.php?name={$row['name']}'>Delete</a>
                  </td>
                </tr>";
        }
        $conn->close();
