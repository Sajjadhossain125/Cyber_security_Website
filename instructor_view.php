      ...
      <tbody>
        ...
        while ($row = $result->fetch_assoc()) {
          echo "<tr>
                  ...
                  <td>{$row['courses']}</td>
                  <td>
                   <span class='edit'> <a  href='update-instructor.php?id={$row['id']}'>Edit</a></span>
                    <a class='delete' href='delete_instructor.php?id={$row['id']}'>Delete</a>
                    <a class='insert' href='insert_instructor.php?id={$row['id']}'>Insert</a>
                  </td>
                </tr>";
        }
        $conn->close();
